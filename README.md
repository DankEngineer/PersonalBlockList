# 🛡 Personal AdBlock Filter List

An aggressive filter list designed to block annoyances and clean up the locations where the ads once were

NOTE: This is an experimental filter primarily intended for my personal use however if you find anything useful feel free to use it in any way you see fit.
